...
final String? currentUserId;
  const ExcelLayout(
      {Key? key, this.document, this.onLongPress, this.isReceiver = false, this.isGroup = false,this.currentUserId,this.onTap,this.isBroadcast  =false})
      : super(key: key);
              ...
              IntrinsicHeight(
                child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                  ...
                  Text(
                      ...
                      style:
                      AppCss.poppinsMedium12.textColor(appCtrl.appTheme.white))
