...
class ChatMessageAppBar extends StatelessWidget with PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
        ...
        leading: SvgPicture.asset(
            ...
            .marginSymmetric(horizontal: Insets.i20, vertical: Insets.i25).inkWell(onTap: ()=> Get.back()),
        actions: [
          ...
          SvgPicture.asset(svgAssets.video, height: Sizes.s20)
              ...
              .decorated(
                  ...
                  borderRadius: BorderRadius.circular(AppRadius.r10))
              .marginSymmetric(vertical: Insets.i25).inkWell(onTap: videoTap),
          SvgPicture.asset(svgAssets.search, height: Sizes.s20)
              ...
              .decorated(
                  ...
                  borderRadius: BorderRadius.circular(AppRadius.r10))
              .marginSymmetric(horizontal: Insets.i10, vertical: Insets.i25).inkWell(onTap: callTap),
          PopupMenuButton(
            color: appCtrl.appTheme.whiteColor,
            ...
            itemBuilder: (ctx) => [
              _buildPopupMenuItem(isBlock ? fonts.unblock.tr : fonts.block.tr, isBlock  ? svgAssets.block : svgAssets.unBlock, 2),
            ],
            child: SvgPicture.asset(svgAssets.more, height: Sizes.s20)
                .paddingAll(Insets.i10),
          )
              .decorated(
                  color: appCtrl.appTheme.white,
  ...
  @override
  Size get preferredSize => const Size.fromHeight(Sizes.s90);
