...
class _StatusLayoutState extends State<StatusLayout> {
  ...
  @override
  void initState() {
    log("dfdf : ${(widget.snapshot!.data!).docs[0]["photoUrl"][(widget.snapshot!
        .data!).docs[0]["photoUrl"].length - 1]["statusType"]}");
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text(appCtrl.storage.read(session.user)["name"],
      ...
      leading: Stack(
        ...
        children: [
          ...
          ["statusType"] ==
            ...
            height: Sizes.s50,
            width: Sizes.s50,alignment: Alignment.center,
