...
class GroupCardSubTitle extends StatelessWidget {
  ...
  final bool hasData;
  const GroupCardSubTitle({Key? key,this.document,this.name,this.currentUserId,this.hasData = false}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: (document!["lastMessage"].contains(".gif"))
          ...
          : Text(
          (document!["lastMessage"].contains("media")) ? hasData ?"$name Media Share" : "Media Share"   :  (document!["lastMessage"].contains(".pdf") ||
